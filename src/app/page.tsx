...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      useInvertedBackground={true}
      heading={[
        { type: "text", content: "Modern, Dinamik ve Şeffaf" },
        { type: "image", src: "http://img.b2bpic.net/free-photo/spacious-room-with-big-window_1203-1490.jpg", alt: "UK Realty Ofis" }
      ]}
    />
  </div>
  ...
  <div id="features" data-section="features">
      ...
      useInvertedBackground={false}
      features={[
        { title: "Yatırım Danışmanlığı", description: "Geleceğinizi güvence altına alan stratejiler.", icon: TrendingUp, mediaItems: [{ imageSrc: "http://img.b2bpic.net/free-photo/caucasian-man-working-with-building-illustration-green-background_53876-30072.jpg" }, { imageSrc: "http://img.b2bpic.net/free-photo/decorated-interior-christmas-beautiful-christmas-tree-near-modern-expensive-couch-big-clock-with-roman-numbers_132075-6150.jpg" }] },
        { title: "Hukuki Süreç Desteği", description: "Tüm tapu ve sözleşme süreçlerinde yanınızdayız.", icon: Scale, mediaItems: [{ imageSrc: "http://img.b2bpic.net/free-photo/hand-filling-document-closeup_1150-14905.jpg" }, { imageSrc: "http://img.b2bpic.net/free-photo/invest-investment-financial-income-profit-costs-concept_53876-134068.jpg" }] },
        { title: "Profesyonel Fotoğrafçılık", description: "Portföyünüzü en iyi şekilde sergiliyoruz.", icon: Camera, mediaItems: [{ imageSrc: "http://img.b2bpic.net/free-photo/brown-vintage-pattern-old-wall-rich-vintage-retro-pattern-interior_482257-31465.jpg" }, { imageSrc: "http://img.b2bpic.net/free-photo/overhead-view-human-hand-putting-signature-official-paper-office_23-2148182971.jpg" }] }
      ]}
      title="Hizmetlerimiz"
  ...
  <div id="referral" data-section="referral">
      ...
      useInvertedBackground={true}
      metrics={[
        { id: "m1", value: "%30", title: "Komisyon Payı", description: "Başarı garantili ortaklık.", imageSrc: "http://img.b2bpic.net/free-photo/sharing-ideas-with-pretty-girlfriend_1098-15697.jpg" },
        { id: "m2", value: "100+", title: "Mutlu İş Ortağı", description: "Şeffaf kazanç süreci.", imageSrc: "http://img.b2bpic.net/free-photo/data-analysis-summary-graph-arrow-up_53876-133586.jpg" },
        { id: "m3", value: "48s", title: "İşleme Alım", description: "En hızlı geri dönüş.", imageSrc: "http://img.b2bpic.net/free-photo/crop-man-holding-paper-house_23-2147764240.jpg" }
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        { id: "t5", name: "Merve Y.", role: "Gayrimenkul Sahibi", company: "UK Realty Partner", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/young-woman-touching-marble-bust_171337-16535.jpg" }
      ]}
